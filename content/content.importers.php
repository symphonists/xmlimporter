<?php
	...
	-------------------------------------------------------------------------*/
		...
		public function __prepareEdit($context) {
			...
			if (!$this->_importer) $this->_importer = new Importer();
		...
		public function __viewEdit() {
			...
			$this->setTitle('Symphony &ndash; ' . $about['name']);
			
			$this->appendSubheading(($about['name'] ? $about['name'] : __('Untitled')));
			
			$fieldset = new XMLElement('fieldset');
			$fieldset->setAttribute('class', 'settings');
			$fieldset->appendChild(new XMLElement('legend', __('Importer Settings')));
